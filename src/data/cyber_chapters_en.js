export const cyberChaptersEn = [
        ...
        levels: [
            {
                ...
                story: "The cursor blinks. You need to verify your location and see what's around you.",
                objective: 'List files in the current directory.',
                hint: 'Type "ls" to list files.',
                initCode: ``,
                expectedCommand: "ls",
                expectedOutput: ["sys_core", "data_logs", "readme.txt"],
                successMessage: "Visibility confirmed.",
                type: 'terminal',
            },
            {
                id: '1-2',
            ...
            {
                id: '1-4',
                title: 'Searching (grep)',
                dialogue: [
                    { speaker: 'Operator', text: "The logs are too vast. We need to find the error code 'ERR_505'." },
                    { speaker: 'System', text: "Use grep to filter text." }
                ],
                story: "Filter the noise to find the signal.",
                objective: 'Search for "ERR_505" in "data_logs".',
                hint: 'Type "grep ERR_505 data_logs"',
                initCode: ``,
                expectedCommand: "grep ERR_505 data_logs",
                expectedOutput: ["[ERROR] 14:02: ERR_505 Connection Refused"],
                successMessage: "Pattern matched.",
                type: 'terminal',
            },
            {
                id: '1-5',
                title: 'Manuals (man)',
                dialogue: [
                    { speaker: 'Operator', text: "A hacker's best friend is documentation. Learn about the 'ls' command." }
                ],
                story: "Knowledge is built, not given.",
    ...
    },
    {
        ...
        levels: [
            {
                id: '2-1',
                title: 'Creation (touch, mkdir)',
                dialogue: [
                    { speaker: 'Operator', text: "Create a workspace. We need a directory called 'exploit_dev'." }
                ],
                story: "Build your lab.",
        ...
        levels: [
            {
                ...
                dialogue: [{ speaker: 'Operator', text: "Check if the target 10.10.10.5 is online." }],
    ...
    },
    {
        ...
        levels: [
            ...
            { id: '4-4', title: 'WHOIS', dialogue: [{ speaker: 'Operator', text: 'Who registered this domain?' }], story: 'Public registry lookup.', objective: 'Check google.com', hint: 'whois google.com', expectedCommand: 'whois google.com', expectedOutput: ['Registrant Organization: Google LLC'], successMessage: 'Registrant found.', type: 'terminal' },
            { id: '4-5', title: 'Google Dorking', dialogue: [{ speaker: 'Operator', text: 'Find PDF files on the site.' }], story: 'Advanced search techniques.', objective: 'Search command mock', hint: 'site:target.com filetype:pdf', expectedCommand: 'site:target.com filetype:pdf', expectedOutput: ['[Link] secret_plan.pdf'], successMessage: 'Dork valid.', type: 'terminal' }
        ]
    },
    {
        id: 'cyber-chapter-5',
        ...
        levels: [
            ...
            { id: '5-2', title: 'Hashing (MD5)', dialogue: [{ speaker: 'Operator', text: 'Hash the word "secret".' }], story: 'One-way functions.', objective: 'MD5 hash "secret"', hint: 'echo -n "secret" | md5sum', expectedCommand: 'echo -n "secret" | md5sum', expectedOutput: ['5ebe2294ecd0e0f08eab7690d2a6ee69  -'], successMessage: 'Hashed.', type: 'terminal' },
            { id: '5-3', title: 'Cracking (John)', dialogue: [{ speaker: 'Operator', text: 'Crack the hash file.' }], story: 'Brute forcing hashes.', objective: 'Run john on hash.txt', hint: 'john hash.txt', expectedCommand: 'john hash.txt', expectedOutput: ['password123'], successMessage: 'Cracked.', type: 'terminal' },
    ...
    },
    {
        ...
        description: 'Exploiting system vulnerabilities.',
        levels: [
            { id: '6-1', title: 'Metasploit Intro', dialogue: [{ speaker: 'Operator', text: 'Initialize the framework.' }], story: 'The ultimate weapon.', objective: 'Start msfconsole', hint: 'msfconsole', expectedCommand: 'msfconsole', expectedOutput: ['msf6 >'], successMessage: 'Console ready.', type: 'terminal' },
            ...
            { id: '6-3', title: 'Reverse Shell', dialogue: [{ speaker: 'Operator', text: 'Catch the connection.' }], story: 'Listening for the callback.', objective: 'Listen on port 4444', hint: 'nc -lvnp 4444', expectedCommand: 'nc -lvnp 4444', expectedOutput: ['Listening on [0.0.0.0] 4444'], successMessage: 'Listener active.', type: 'terminal' },
            ...
            { id: '6-5', title: 'Searchsploit', dialogue: [{ speaker: 'Operator', text: 'Find exploits for Apache 2.4.' }], story: 'Consulting the archives.', objective: 'Search exploits', hint: 'searchsploit Apache 2.4', expectedCommand: 'searchsploit Apache 2.4', expectedOutput: ['Apache 2.4.49 - Path Traversal'], successMessage: 'Exploit found.', type: 'terminal' }
        ]
    },
    {
        id: 'cyber-chapter-7',
        ...
        levels: [
            { id: '7-1', title: 'SQL Injection', dialogue: [{ speaker: 'Operator', text: 'Bypass login.' }], objective: 'Enter payload.', hint: "' OR 1=1 --", expectedCommand: "' OR 1=1 --", expectedOutput: ['Welcome Admin'], successMessage: 'Injected.', type: 'terminal' },
            { id: '7-2', title: 'XSS', dialogue: [{ speaker: 'Operator', text: 'Pop an alert box.' }], objective: 'Enter script tag.', hint: '<script>alert(1)</script>', expectedCommand: '<script>alert(1)</script>', expectedOutput: ['[Alert] 1'], successMessage: 'Script executed.', type: 'terminal' },
            { id: '7-3', title: 'Command Injection', dialogue: [{ speaker: 'Operator', text: 'Read /etc/passwd via the web.' }], objective: 'Inject cat command.', hint: '; cat /etc/passwd', expectedCommand: '; cat /etc/passwd', expectedOutput: ['root:x:0:0:...'], successMessage: 'File read.', type: 'terminal' },
            { id: '7-4', title: 'Burp Suite', dialogue: [{ speaker: 'Operator', text: 'Intercept the request.' }], objective: 'Mock start burp.', hint: 'burpsuite', expectedCommand: 'burpsuite', expectedOutput: ['Proxy running...'], successMessage: 'Intercepting.', type: 'terminal' },
            { id: '7-5', title: 'Fuzzing (ffuf)', dialogue: [{ speaker: 'Operator', text: 'Find hidden directories.' }], objective: 'Fuzz target URL.', hint: 'ffuf -u http://target/FUZZ -w wordlist.txt', expectedCommand: 'ffuf -u http://target/FUZZ -w wordlist.txt', expectedOutput: ['admin', 'backup'], successMessage: 'Dirs found.', type: 'terminal' }
        ]
    },
    {
        id: 'cyber-chapter-8',
        ...
        levels: [
            ...
            { id: '8-5', title: 'Evil Twin', dialogue: [{ speaker: 'Operator', text: 'Create fake AP.' }], objective: 'Start access point', hint: 'airbase-ng -e "Free Wifi" wlan0mon', expectedCommand: 'airbase-ng -e "Free Wifi" wlan0mon', expectedOutput: ['AP Created'], successMessage: 'Trap set.', type: 'terminal' }
        ]
    },
    {
        id: 'cyber-chapter-9',
        ...
        levels: [
            ...
            { id: '9-2', title: 'Log Analysis', dialogue: [{ speaker: 'Operator', text: 'Check auth logs.' }], objective: 'Grep for failures', hint: 'grep "Failed" /var/log/auth.log', expectedCommand: 'grep "Failed" /var/log/auth.log', expectedOutput: ['Failed password for root'], successMessage: 'Intrusion attempts spotted.', type: 'terminal' },
    ...
    },
    {
        ...
        levels: [
            ...
            { id: '11-4', title: 'Socket Prog', dialogue: [{ speaker: 'Operator', text: 'Open a socket.' }], objective: 'Run server.py', hint: 'python3 server.py', expectedCommand: 'python3 server.py', expectedOutput: ['Listening...'], successMessage: 'Server up.', type: 'terminal' },
            { id: '11-5', title: 'API Interaction', dialogue: [{ speaker: 'Operator', text: 'Query the API.' }], objective: 'Curl the endpoint', hint: 'curl http://api.loc/v1', expectedCommand: 'curl http://api.loc/v1', expectedOutput: ['{"status": "ok"}'], successMessage: 'Data received.', type: 'terminal' }
        ]
    },
    {
        id: 'cyber-chapter-12',
        title: 'Chapter XII: The Professional Path',
        description: 'Ethics, reporting, and operational security.',
        levels: [
            { id: '12-1', title: 'Report Writing', dialogue: [{ speaker: 'Operator', text: 'Calculate the CVSS score.' }], objective: 'Input Score', hint: '9.8', expectedCommand: '9.8', expectedOutput: ['Critical'], successMessage: 'Score recorded.', type: 'terminal' },
            ...
            { id: '12-4', title: 'CVE Research', dialogue: [{ speaker: 'Operator', text: 'Lookup CVE-2021-44228.' }], objective: 'Search CVE', hint: 'search cve-2021-44228', expectedCommand: 'search cve-2021-44228', expectedOutput: ['Log4Shell'], successMessage: 'Vulnerability details loaded.', type: 'terminal' },
    ...
    {
        id: 'cyber-chapter-13',
        title: 'Chapter XIII: The Enterprise (Active Directory)',
        description: 'Conquer the Windows Domain environment.',
        levels: [
            ...
            { id: '13-2', title: 'Bloodhound', dialogue: [{ speaker: 'Operator', text: 'Map the attack path.' }], objective: 'Start ingestor', hint: 'bloodhound-python', expectedCommand: 'bloodhound-python', expectedOutput: ['Data collected'], successMessage: 'Graph built.', type: 'terminal' },
            ...
            { id: '13-4', title: 'SMB Relay', dialogue: [{ speaker: 'Operator', text: 'Relay the hash.' }], objective: 'ntlmrelayx', hint: 'ntlmrelayx.py -tf targets.txt', expectedCommand: 'ntlmrelayx.py -tf targets.txt', expectedOutput: ['Relay successful'], successMessage: 'Access granted.', type: 'terminal' },
            { id: '13-5', title: 'Golden Ticket', dialogue: [{ speaker: 'Operator', text: 'Forge the ticket.' }], objective: 'ticketer', hint: 'ticketer.py', expectedCommand: 'ticketer.py', expectedOutput: ['ticket.ccache created'], successMessage: 'Persistence achieved.', type: 'terminal' }
        ]
    },
    {
        id: 'cyber-chapter-14',
        title: 'Chapter XIV: Cloud & API Warfare',
        description: 'Hacking the modern stack (AWS, Docker, APIs).',
        levels: [
            { id: '14-1', title: 'S3 Enum', dialogue: [{ speaker: 'Operator', text: 'List bucket contents.' }], objective: 'aws s3 ls', hint: 'aws s3 ls s3://bucket', expectedCommand: 'aws s3 ls s3://bucket', expectedOutput: ['passwords.txt'], successMessage: 'Leaks found.', type: 'terminal' },
            ...
            { id: '14-3', title: 'API Theft', dialogue: [{ speaker: 'Operator', text: 'Steal the JWT.' }], objective: 'Decode token', hint: 'jwt_tool.py token', expectedCommand: 'jwt_tool.py token', expectedOutput: ['Alg: HS256'], successMessage: 'Token decoded.', type: 'terminal' },
            { id: '14-4', title: 'GraphQL', dialogue: [{ speaker: 'Operator', text: 'Introspect the schema.' }], objective: 'Query schema', hint: '{__schema{types{name}}}', expectedCommand: '{__schema{types{name}}}', expectedOutput: ['"name": "User"'], successMessage: 'Schema mapped.', type: 'terminal' },
